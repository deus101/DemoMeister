...
{       
		...
		//new Shit
		vec4 EUS = vec4( 0.5,  0.5,  0.5, 0.0);

		vec4 EUN = vec4( 0.5,  0.5,  -0.5, 0.0);

		vec4 WUN = vec4( -0.5,  0.5,  -0.5, 0.0);

		vec4 WUS = vec4( -0.5,  0.5,  0.5, 0.0);


		vec4 EDS = vec4( 0.5,  -0.5,  0.5, 0.0);

		vec4 EDN = vec4( 0.5,  -0.5,  -0.5, 0.0);

		vec4 WDN = vec4( -0.5,  -0.5,  -0.5, 0.0);

		vec4 WDS = vec4( -0.5,  -0.5,  0.5, 0.0);
